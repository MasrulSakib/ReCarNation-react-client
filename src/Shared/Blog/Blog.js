...
const Blog = () => {
    return (
        <div className='md:container md:mx-auto mx-5 text-left my-16 flex flex-col gap-10'>
            <div>
                <h2 className="md:text-2xl text-lg mb-3 font-semibold text-error">1. What are the different ways to manage a state in a React application?</h2>
            ...
            <div>
                <h2 className="md:text-2xl text-lg mb-3 font-semibold text-error">2. How does prototypical inheritance work?</h2>
                <p className='text-sm md:text-base'>
            ...
            <div>
                <h2 className="md:text-2xl text-lg mb-3 font-semibold text-error">3. What is a unit test? Why should we write unit tests?</h2>
                <p className='text-sm md:text-base'>
            ...
            <div>
                <h2 className="md:text-2xl text-lg mb-3 font-semibold text-error">4. React vs. Angular vs. Vue?</h2>
                <p className='text-sm md:text-base'>
